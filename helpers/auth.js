...
helpers.verifyRecaptcha = async (req, res, next) => {
  	...
  	const verificationURL = "https://www.google.com/recaptcha/api/siteverify?secret=" + gSecretKey + "&response=" + req.body['g-recaptcha-response'] + "&remoteip=" + req.connection.remoteAddress;
